...
[![Domain count](https://img.shields.io/badge/domains-220%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
## Data format
After unpacking, domain lists are just text files (~4.4Gb at 220 mil) with one domain per line.
