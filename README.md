...
[![Domain count](https://img.shields.io/badge/domains-300%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 1TB of Internet traffic is necessary to get 300 million domains (3.4TB / 1 million).
- Only 1.1Gb of disk space is required to store 300 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~6.4Gb at 300 mil) with one domain per line.
