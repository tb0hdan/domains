...
[![Domain count](https://img.shields.io/badge/domains-234%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 500TB of Internet traffic is necessary to get 234 million domains (6.6TB / 1 million).
- Only 938 Mbytes of disk space is required to store 234 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~4.7Gb at 234 mil) with one domain per line.
