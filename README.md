...
[![Domain count](https://img.shields.io/badge/domains-420%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
## Data format
After unpacking, domain lists are just text files (~9.8Gb at 420 mil) with one domain per line.
