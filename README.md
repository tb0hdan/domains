...
[![Domain count](https://img.shields.io/badge/domains-281%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 925TB of Internet traffic is necessary to get 281 million domains (3.7TB / 1 million).
- Only 1.1Gb of disk space is required to store 281 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~5.9Gb at 281 mil) with one domain per line.
