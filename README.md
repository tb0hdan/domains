...
[![Domain count](https://img.shields.io/badge/domains-342%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
## Data format
After unpacking, domain lists are just text files (~8.2Gb at 342 mil) with one domain per line.
