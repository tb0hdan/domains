...
[![Domain count](https://img.shields.io/badge/domains-385%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 1.3PB of Internet traffic is necessary to crawl 385 million domains (3.4TB / 1 million).
- Only 2.5Gb of disk space is required to store 385 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~8.2Gb at 385 mil) with one domain per line.
