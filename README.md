...
[![Domain count](https://img.shields.io/badge/domains-230%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 500TB of Internet traffic is necessary to get 230 million domains (6.6TB / 1 million).
- Only 921 Mbytes of disk space is required to store 230 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~4.6Gb at 230 mil) with one domain per line.
