...
[![Domain count](https://img.shields.io/badge/domains-380%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 1PB of Internet traffic is necessary to crawl 380 million domains (3.4TB / 1 million).
- Only 2.5Gb of disk space is required to store 380 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~8.1Gb at 380 mil) with one domain per line.
