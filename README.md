...
[![Domain count](https://img.shields.io/badge/domains-265%20million-brightgreen)](https://github.com/tb0hdan/domains/blob/master/STATS.md)
...
- More than 925TB of Internet traffic is necessary to get 265 million domains (3.7TB / 1 million).
- Only 1.1Gb of disk space is required to store 265 million domains in compressed form
...
## Data format
After unpacking, domain lists are just text files (~5.4Gb at 265 mil) with one domain per line.
